---
title: "Comparaison des résultats de Random Forest avec R et python avec le package reticulate"
author: "Marie Morvan"
date: "27/08/2019"
...
# Comparaison des résultats de RandomForest issus de plusieurs fonctions R
...
t0r = Sys.time() 
RFr = ranger(Class ~ ., data = dta[train, ])
t1r = Sys.time() 
tcalc_r = t1r - t0r
...
## En utilisant directement les modules python pour modéliser les données
...
Y         = np$array(as.numeric(DNA$Class[train]))
fitpy     = RFpy$fit(X, Y)
...
## Utiliser une fenêtre interactive Python dans la session R
```r
repl_python()
